...
# writes audio into a shared-memory ring that the separate ForceAudioJack
# addon's forceAudioJack.so (LD_PRELOAD'd into MPC) mixes into what MPC reads
...
echo "  logs: /tmp/forceAudioJack.log (mix tap, in the ForceAudioJack addon), /tmp/maze_host.log (synth)"
